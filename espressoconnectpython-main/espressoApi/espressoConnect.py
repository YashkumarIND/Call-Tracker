...
class EspressoConnect(object):
    ...
    _default_timeout = 500 # In seconds
    ...
    def get_access_token(self, api_key, encStr, state=''):
...
# # Usage
# access_token="eyJ0eXAiOiJzZWMiLCJhbGciOiJIUzI1NiJ9..1i67GVYHBVt5VK_226ZaE9A8Y0FcIrIOs0237MEWCCA"
# exchange = "NC"
# scripcode = 25
# interval = "daily"
# api_key = "9WNvZElRE24hSAsBfcCLNXZEx0JFhlFx"



# espressoApi = EspressoConnect(api_key=api_key,access_token=access_token)

# historical_data = espressoApi.historicaldata(exchange, scripcode, interval)

# print(historical_data)



access_token = "eyJ0eXAiOiJzZWMiLCJhbGciOiJIUzI1NiJ9..DFBcji-XjitDCIXaGl_Vitv946cEBg1AYNaM1qIQVMg"
...
# // Scripmaster API (without access token) by CSV
